...
以 LeetCode 704「二分查找」为例，EasyCode 将本地作答、Python 测试、AI 五维评测、过程回放和间隔复习串成一条完整的训练路径。
...
将评测结果导出为分享卡片或 Markdown。卡片集中呈现题目、掌握度评级、五维表现和主诊断，便于保存和分享。

![EasyCode 704 二分查找分享卡片、A 评级与五维雷达图](assets/screenshots/easycode-share-card.png)
